...
public class Flake {
    ...
    public void recursiveSnow(Point startPoint, Point endPoint, int depth) {
        if (depth > 0) {
            double shiftX = startPoint.getX(), shiftY = startPoint.getY();
            endPoint.translate(-shiftX, -shiftY);
            // rotate to horizontal
            double angle = Math.atan(endPoint.getY() / endPoint.getX());
            ...
            // Recursion: create new flake for each segment
